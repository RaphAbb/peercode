...
class Graph {
 private:
  ...
  std::vector<Point> point_list_; // List of points where nodes are located
  std::vector<std::vector<unsigned>> edge_list_; // mx2 List of edges and either node ids
  std::vector<std::vector<unsigned>> adj_list_; // List of neighbors of each node
 public:
