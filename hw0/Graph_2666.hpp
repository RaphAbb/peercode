...
class Graph {
 ...
 public:
  ...
  class Edge {
   public:
    /** Construct an invalid Edge. */
      // HW0: YOUR CODE HERE
    Edge(const Graph* g, size_type i_1, size_type i_2): n_1(i_1), n_2(i_2)
    {
      graph = g;
    }
    ...
    Node node1() const {
      // HW0: YOUR CODE HERE
      return Node(graph, n_1);  
    }

    /** Return the other node of this Edge */
    Node node2() const {
      // HW0: YOUR CODE HERE
      return Node(graph, n_2); 
    }
    ...
    bool operator==(const Edge& e) const {
      return ((e.graph==graph) && (e.n_1==n_1) && (e.n_2==n_2)) || ((e.graph==graph) && (e.n_2==n_1) && (e.n_1==n_2));
    }
     ...
     */
    bool operator<(const Edge& e) const {
      size_type this_min = std::min(n_1, n_2);
      size_type this_max = std::max(n_1, n_2);
      size_type e_min = std::min(e.n_1, e.n_2);
      size_type e_max = std::max(e.n_1, e.n_2);
      return (this_min < e_min) || ((this_min == e_min) && (this_max < e_max));
    }
  ...
  Edge edge(size_type i) const {
    // HW0: YOUR CODE HERE
    const std::pair<size_type, size_type> & ids = edge_map.at(i);
    return Edge(this, ids.first, ids.second); 
  }
  ...
  bool has_edge(const Node& a, const Node& b) const {
    ...
    return alist->second.find(b.idx) != alist->second.end();
  }
