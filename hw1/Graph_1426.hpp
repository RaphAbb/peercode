 ...
 public:
  ...
  class Edge : private totally_ordered<Edge> {
   public:
    ...
    bool operator==(const Edge& e) const {
      ...
      if (this->G_ == e.G_
        and this->std::min(nodepair_.first, nodepair_.second) == 
          std::min(e.nodepair_.first, e.nodepair_.second)
        and this->std::max(nodepair_.first, nodepair_.second) == 
  ...
  class IncidentIterator : private totally_ordered<IncidentIterator> {
   public:
    ...
    Edge operator*() const {
      ...
      // Build the edge
      Edge e {this->G_,std::make_pair(this->node_->uid_, adj_uid)};
  ...
  class EdgeIterator : private totally_ordered<EdgeIterator> {
   public:
     ...
     */
    Edge operator*() const {
      Edge e {this->G_, this->G_->edges_.at(this->index_)};
      return e;
    }
    /**
